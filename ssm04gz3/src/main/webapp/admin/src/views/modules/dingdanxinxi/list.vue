		     ...
		     <template slot-scope="scope">
              ...
              <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('dingdanxinxi','查看') && contents.tableBtnIcon == 0" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                                                                <el-button v-if="isAuth('dingdanxinxi','配送') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="peisongxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'配送':'' }}</el-button>
                <el-button v-if="isAuth('dingdanxinxi','配送') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="peisongxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'配送':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('dingdanxinxi','配送') && contents.tableBtnIcon == 0" type="success" size="mini" @click="peisongxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'配送':'' }}</el-button>
                                                <el-button v-if="isAuth('dingdanxinxi','投诉') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="dingdantousuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'投诉':'' }}</el-button>
                <el-button v-if="isAuth('dingdanxinxi','投诉') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="dingdantousuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'投诉':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('dingdanxinxi','投诉') && contents.tableBtnIcon == 0" type="success" size="mini" @click="dingdantousuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'投诉':'' }}</el-button>
  ...
  methods: {
    ...
    contentPageStyleChange(){
      ...
      this.contents.pageEachNum = 10
            ...
            peisongxinxiCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
